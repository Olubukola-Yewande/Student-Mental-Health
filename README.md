...
This report shows the count of students experiencing depression, grouped by their age. I calculated the count of depression by age. I put age on the X axis, while I put the count of depression on the Y axis.<br>
The age range is from 18 to 24. Students who are 18 and 19 are experiencing more depression. The depression count from 20 to 22 years is balanced. From age 23 to 24, the depression rate is high. 
...
From this analysis, there are many courses in the dataset but it was filtered to the top 8 courses. BCS, Engineering, KOE, and BIT are the top 4 courses with high panic attack count. Other courses have panic attack count but those top 4 are the leading. From this insight, we can see that students who are offering BCS, Engineering, KOE, and BIT are expeririencing panic attack.

**5. Students with Panic Attack by Current Year of Study**<br>
Students who are in year 1 and year 3 have the highest panic attack count followed by year 2. Students in year 4 has the lowest panic attack count which is 1. The insight driven from this is that, students in year 1 have panic attack but in year 2, it reduced a bit. In year 3, it goes high but got better in year 4.
...
Students with CGPA that ranges from 0 - 2.99 are not really experiencing anxiety. Only one student is experiencing anxiety in this CGPA range. However, students with CGPA that ranges from 3.00 to 4.00 are experiencing anxiety. The insight gotten from this is that the higher the CGPA, the higher the anxiety and the lower the CGPA, the lower anxiety.
...
This report displays the count of students experiencing anxiety, grouped by the current year of study. Students who are in year 1, 2 and 3 are experiencing more anxiety. Students in year 4 has only 25% percent rate of anxiety compared to year 1, 2 and 3 which are 32.56, 38.46 and 33.33% respectively.
